	...
	SPELLINFO_WSG_FLAGS = {
		['Alliance'] 	= {['icon'] = [[Interface\Icons\inv_bannerpvp_02]], ['worldFrameIcon'] = [[Interface\WorldStateFrame\AllianceFlag]]},
		['Horde'] 		= {['icon'] = [[Interface\Icons\inv_bannerpvp_01]], ['worldFrameIcon'] = [[Interface\WorldStateFrame\HordeFlag]]},
	}
