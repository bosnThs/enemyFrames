	...
	SPELLINFO_INTERRUPT_BUFFS_TO_TRACK = {
		-- MISC
		['Inferno Effect'] = true, ['Iron Grenade'] = true,  ['Reckless Charge'] = true, ['Tidal Charm'] = true, ['Thorium Grenade'] = true, ['War Stomp'] = true,
		-- DRUID
	...
	SPELLINFO_BUFFS_TO_TRACK = {
        ...
        -- MISC & MOBS
		['Anti-Magic Shield']   	= {['icon'] = [[Interface\Icons\spell_shadow_antimagicshell]], 		['duration'] = 8,	['type'] = 'magic',	['prio'] = 1},
		...
		['Honorless Target']		= {['icon'] = [[Interface\Icons\Spell_magic_lesserinvisibilty]],	['duration'] = 30,	['display'] = false,},
		...
		['Damage Absorb']			= {['icon'] = [[Interface\Icons\Spell_holy_devotionaura]],			['duration'] = 15,	['display'] = false,},
		['Tidal Charm'] 			= {['icon'] = [[Interface\Icons\Spell_frost_summonwaterelemental]], ['duration'] = 3, 	['type'] = 'magic', 	['prio'] = 2},
		['War Stomp']   			= {['icon'] = [[Interface\Icons\Ability_warstomp]], 				['duration'] = 2,	['type'] = 'physical',	['prio'] = 1},
		...
		['Cyclone'] 				= {['icon'] = [[Interface\Icons\Spell_nature_earthbind]], 			['duration'] = 6, 	['type'] = 'physical', 	['prio'] = 2,},
		...
		['Silencing Shot']			= {['icon'] = [[Interface\Icons\Ability_theblackarrow]],			['duration'] = 3, 	['type'] = 'magic',		['prio'] = 2},
		["Freezing Trap Effect"] 	= {['icon'] = [[Interface\Icons\Spell_frost_chainsofice]], 			['duration'] = 20, 	['type'] = 'magic',		['prio'] = 3},
		['Viper Sting']				= {['icon'] = [[Interface\Icons\Ability_hunter_aimedshot]], 		['duration'] = 8, 	['type'] = 'poison', 	['prio'] = 2},
		...
		['Ignite']					= {['icon'] = [[Interface\Icons\Spell_fire_incinerate]],			['duration'] = 4,	['display'] = false,	['type'] = 'magic'},
		['Impact'] 					= {['icon'] = [[Interface\Icons\Spell_fire_meteorstorm]], 			['duration'] = 2, 	['type'] = 'physical', 	['prio'] = 1},
		['Fire Vulnerability']		= {['icon'] = [[Interface\Icons\Spell_fire_soulburn]],				['duration'] = 30,	['display'] = false,	['type'] = 'magic'},
    	...
    	['Hand of Protection'] 		= {['icon'] = [[Interface\Icons\Spell_holy_sealofprotection]], 		['duration'] = 10, 	['type'] = 'magic', 	['prio'] = 2},
		...
		["Hammer of Justice"] 		= {['icon'] = [[Interface\Icons\Spell_holy_sealofmight]], 			['duration'] = 6, 	['type'] = 'magic',		['prio'] = 1,	['dr'] = 'Controlled Stun'},
		...
		['Vengeance']				= {['icon'] = [[Interface\Icons\Ability_racial_avatar]],			['duration'] = 8,	['display'] = false,},
		['Vindication']				= {['icon'] = [[Interface\Icons\Spell_holy_vindication]],			['duration'] = 10,	['display'] = false,},
		['Crusader Strike']			= {['icon'] = [[Interface\Icons\Spell_Holy_CrusaderStrike]],		['duration'] = 30,	['type'] = 'magic',		['display'] = false,},
		...
		['Chastise'] 				= {['icon'] = [[Interface\Icons\Spell_holy_chastise]], 				['duration'] = 2, 	['type'] = 'physical', 	['prio'] = 1},
		['Devouring Plague']		= {['icon'] = [[Interface\Icons\Spell_shadow_blackplague]],			['duration'] = 24,	['display'] = false,},
		['Fade']					= {['icon'] = [[Interface\Icons\Spell_magic_lesserinvisibilty]],	['duration'] = 10,	['display'] = false,},
    	...
    	['Pain Suppression']    	= {['icon'] = [[Interface\Icons\Spell_holy_painsupression]], 		['duration'] = 8, 	['type'] = 'magic', 	['prio'] = 2},
    	['Power Word: Shield']    	= {['icon'] = [[Interface\Icons\Spell_holy_powerwordshield]], 		['duration'] = 30, 	['type'] = 'magic', 	['prio'] = 1},
		...
		['Blind']					= {['icon'] = [[Interface\Icons\Spell_shadow_mindsteal]],			['duration'] = 10,	['type'] = 'physical',	['prio'] = 3},
		["Cheap Shot"] 				= {['icon'] = [[Interface\Icons\Ability_cheapshot]], 				['duration'] = 4, 	['type'] = 'physical', 	['prio'] = 1},
		['Cloak of Shadows']		= {['icon'] = [[Interface\Icons\Spell_shadow_nethercloak]],			['duration'] = 5,	['prio'] = 3},
		...
		['Remorseless']				= {['icon'] = [[Interface\Icons\Ability_fiegndead]],				['duration'] = 20,	['display'] = false,},
		...
		['Immolate']				= {['icon'] = [[Interface\Icons\Spell_fire_immolation]],			['duration'] = 15, 	['type'] = 'magic',},		
		['Nether Protection']		= {['icon'] = [[Interface\Icons\Spell_shadow_netherprotection]],	['duration'] = 4,	['type'] = 'magic',		['prio'] = 1},
		['Sacrifice']    			= {['icon'] = [[Interface\Icons\Spell_shadow_sacrificialshield]], 	['duration'] = 30, 	['type'] = 'magic', 	['prio'] = 2},
		...
		['Unstable Affliction']		= {['icon'] = [[Interface\Icons\Spell_shadow_unstableaffliction]],	['duration'] = 16,	['type'] = 'magic', 	['prio'] = 2},
		...
		['Blood Craze']				= {['icon'] = [[Interface\Icons\Spell_shadow_summonimp]], 			['duration'] = 6,	['display'] = false,},
		...
		['Charge Stun'] 			= {['icon'] = [[Interface\Icons\Spell_frost_stun]], 				['duration'] = 1, 	['type'] = 'physical', 	['prio'] = 1,	['dr'] = 'Controlled Stun'},
		...
		['Hamstring'] 				= {['icon'] = [[Interface\Icons\Ability_shockwave]], 				['duration'] = 15, 	['type'] = 'physical',},		
		['Improved Hamstring'] 		= {['icon'] = [[Interface\Icons\Ability_shockwave]], 				['duration'] = 5, 	['type'] = 'physical', 	['prio'] = 1},
		...
		['Mocking Blow']			= {['icon'] = [[Interface\Icons\Ability_warrior_punishingblow]], 	['duration'] = 6,	['display'] = false,},
	...
	SPELLINFO_DEBUFF_REFRESHING_SPELLS = {
		...
		['Scorch']			= {'Improved Scorch','Fire Vulnerability'},
		-- PALADIN
