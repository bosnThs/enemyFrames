    SPELLINFO_SPELLCASTS_TO_TRACK = {
		...
		['Arcane Explosion']			= {['icon'] = [[Interface\Icons\spell_nature_wispsplode]], 			['casttime'] = 1.5},
		...
		['Shadow Bolt Volley']			= {['icon'] = [[Interface\Icons\spell_shadow_shadowbolt]], 			['casttime'] = 3},
...
--        ['Evocation']               = {[[Interf ace\Icons\Spell_nature_purge]], 8},
	...
	SPELLINFO_CHANNELED_SPELLCASTS_TO_TRACK = {
		-- MISC
		['Fishing']					= {['icon'] = [[Interface\Icons\Ability_racial_cannibalize]],['casttime'] = 30,	['immune'] = true,},
