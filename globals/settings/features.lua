	...
	container:Hide()
	-------------------------------------------------------------------------------
	local checkBoxFeaturesN, checkBoxFeatures  = 4, { 	[1] = {['id'] = 'enableOutdoors', 		['label'] = 'Enable outside of BattleGrounds'},
														...
														[2] = {['id'] = 'targetPortraitDebuff', ['label'] = 'Prio debuff on Target Portrait'},
														[3] = {['id'] = 'playerPortraitDebuff', ['label'] = 'Prio debuff on Player Portrait'},
														[4] = {['id'] = 'targetDebuffTimers', 	['label'] = 'Debuff timers on target'},
														
													}
	local checkBoxFeaturesBGN, checkBoxFeaturesBG  = 2, {	--[1] = {['id'] = 'incomingSpells', 		['label'] = 'Incoming Spells (BGs only)'},
															[1] = {['id'] = 'pvpmapblips', 			['label'] = 'Class colored map blips'},
															[2] = {['id'] = 'efcBGannouncement', 	['label'] = 'Low Health EFC announcement'},
